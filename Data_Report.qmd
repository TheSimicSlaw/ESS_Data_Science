...
\[any further details of LDA - Bayesian origins? - put discriminant formula here\]\
\[objective of using LDA\]\
\[R code for LDA model .lda\]\
\[confusion matrices (images/tables) and what they mean\]\
\[relative importance of variables, check using magnitude of discriminant scores. lda_model\$scaling\]\
...
K-fold cross validation was used to determine the accuracy of the model. \[K-fold R code here\]\
Results of the K-fold :\
Central Europe :\
\~89.24% Eastern Europe :\
\~82.11% Nordics :\
\~94.16% Southern Europe :\
\~86.65% UK :\
\~86.22% Western Central Europe :\
\~87.67% The overall accuracy of the K-fold was \~87.68%.\
\[feel free to rearrange and readjust as needed, just please don’t delete my stuff without asking\]
